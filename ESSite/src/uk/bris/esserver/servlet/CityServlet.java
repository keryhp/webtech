...
public class CityServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map<String, Object> lcityAsMap = new HashMap<String, Object>();
		for (City city : lcity) {
			lcityAsMap.put(new Integer(city.getId()).toString(), city.getCityAsMap());
		}
		JSONObject obj = new JSONObject(lcityAsMap);
